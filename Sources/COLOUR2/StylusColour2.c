/*
    ...
    Revisions by Rich Mellor
    Updated 27 July 1999 to include 720 and 1440 dpi print modes
    Updated 22 January 2000 to implement delta row compression
    Updated 29 December 2001 to implement flush buffers
*/
...
Error InitInit(Gstate gstate, char *device, PBbox *area)
{
    ...
    /* Set up any initial defaults when start a print run here
       Such as di->copies=1
    */

    /* Open the print device - either default or as specified by user */
    if (device && *device)
...
/* This is the colour replacement code to convert the grey shade to the
   nearest colour specified in the above table??
*/
...
DRIVdriver dpi180={
    ...
    "Epson Stylus Colour v1.05 180dpi colrep", /* name */
    180,180,                    /* xdpi, ydpi */
    {                           /* mode 4 bitmap */
...
DRIVdriver dpi360={
    ...
    "Epson Stylus Colour v1.05 360dpi colrep", /* name */
    360,360,                    /* xdpi, ydpi */
    {                           /* mode 4 bitmap */
...
DRIVdriver init={
    ...
    "Epson Stylus Colour v1.05 720dpi colrep", /* name */
    720,720,                    /* xdpi, ydpi */
    {                           /* mode 4 bitmap */
        4, 1,                   /* 1 planes, 1 pixel deep */
        BITMAP_NO_BYTEGROUPING, /* no byte grouping */
...
DRIVdriver dpi1440={
    ...
    "Epson Stylus Colour v1.05 1440dpi colrep", /* name */
    1440,720,                   /* xdpi, ydpi */
    {                           /* mode 4 bitmap */
        4, 1,                   /* 1 planes, 1 pixel deep */
        BITMAP_NO_BYTEGROUPING, /* no byte grouping */
